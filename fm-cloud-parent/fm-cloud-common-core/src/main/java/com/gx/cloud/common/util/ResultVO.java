...
public final class ResultVO implements Serializable {
    ...
    public final static  Map<String, Object> success(String message, Object data,String jwtToken,Boolean success) {
        ...
        map.put("code", ExceptionCode.SUCCESS.getCode());
    ...
    public final static  Map<String, Object> success(Object data,String jwtToken) {
        ...
        map.put("jwtToken",jwtToken);
        map.put("code", ExceptionCode.SUCCESS.getCode());
        map.put("message", ExceptionCode.SUCCESS.getMessage());
        map.put("data", data);
    ...
    public final static  Map<String, Object> failure(ExceptionCode respCode, Object data, Boolean success) {
        return getStringObjectMap(respCode, data,success);
    }

    public final static  Map<String, Object> failure(ExceptionCode respCode, Boolean success) {
     ...
     * 成功返回特定的状态码和信息
     * */
    public final static  Map<String, Object> result(ExceptionCode respCode, Object data, Boolean success) {
        return getStringObjectMap(respCode, data,success);
    }

    private static  Map<String, Object> getStringObjectMap(ExceptionCode respCode, Object data, Boolean success) {
        Map<String, Object> map = new HashMap<String, Object>();
     ...
     * 成功返回特定的状态码和信息
     * */
    public final static  Map<String, Object> result(ExceptionCode respCode, Boolean success) {
        return getStringObjectMap(respCode,success);
    }

    private static Map<String, Object> getStringObjectMap(ExceptionCode respCode, Boolean success) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("code", respCode.getCode());
        map.put("message", respCode.getMessage());
        map.put("data", null);
     ...
     * 成功返回特定的状态码和信息
     * */
    public final static Map<String, Object> result(ExceptionCode respCode, String jwtToken, Boolean success) {
        Map<String, Object> map = new HashMap<String, Object>();
